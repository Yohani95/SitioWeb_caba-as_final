...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <input type="hidden" name="codigo" value="<?php echo $_GET["c"];  ?>">
                
                <button class="btn btn-primary" type="submit" href="usuarios.php">Confirmar</button>
                <a class="btn btn-secondary" href="usuarios.php">Cancelar</a>
            </form>
            <br>
            <?php
            //FUNCION LLAMA AL METODO PARA ELIMINAR USUARIO 
